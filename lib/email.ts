...
<body style="background:#f4f4f4;font-family:Arial,sans-serif;margin:0;padding:20px">
  <div style="max-width:580px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden">
    ...
    <div style="padding:40px">
      ...
      <p style="color:#6b7280;font-size:14px">Not downloaded yet? Visit <a href="https://advoverse.com" style="color:#f59e0b">advoverse.com</a></p>
      <p style="color:#6b7280;font-size:14px">Issues? Email us: <a href="mailto:support@advoverse.com" style="color:#f59e0b">support@advoverse.com</a></p>
    </div>
    <div style="background:#f9fafb;padding:20px 40px;text-align:center;color:#9ca3af;font-size:12px">
      <p>&copy; 2026 Advoverse. All Rights Reserved.</p>
    </div>
  </div>
</body>
</html>`,
...
export async function sendAdminNotification(params: {
  ...
  await resend.emails.send({
    from: FROM,
    to: ADMIN_EMAIL,
    subject: `New Sale: ${planName} - Rs.${(amount / 100).toLocaleString('en-IN')}`,
  ...
  <table style="width:100%;border-collapse:collapse">
    ...
    <tr><td style="padding:8px 0;color:#6b7280">Amount</td><td><strong>Rs.${(amount / 100).toLocaleString('en-IN')}</strong></td></tr>
